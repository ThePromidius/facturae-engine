...
| `RegistroAnterior` | Bloque obligatorio para el encadenamiento (Blockchain-like). | Art. 7.a |

### Bloque `<RegistroAnterior>`
Este bloque es la base de la trazabilidad:
...
4. **Huella**: El hash SHA-256 del registro previo.

---
*Documentación técnica para desarrolladores basada en la Orden HAC/1177/2024. Implementado en `src/internal/aeat/types.go`*
